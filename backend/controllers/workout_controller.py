...
class WorkoutController:
    ...
    def get_rule_based_plan(self, user: User) -> dict:
        generated_workout_plan, workout_plan_id = self.service.generate_rule_based_plan(user)
        return {"plan": generated_workout_plan.plan, "plan_id": workout_plan_id}

    def get_csp_plan(self, user: User) -> dict:
        generated_workout_plan, workout_plan_id = self.service.generate_csp_plan(user)
